@extends('layout.main')
@section('title', 'Proses Kerjaan')

@section('content')
    <div class="card">
        <div class="card-header">
            <p class="m-0 p-0"><strong>Proses Kerjaan</strong></p>
        </div>
        <div class="card-body">
            {{-- create tambah kerjaan --}}
            <a href="{{ route('admin.kerjaan.create') }}" class="btn btn-primary btn-sm mb-2">Tambah Kerjaan</a>
